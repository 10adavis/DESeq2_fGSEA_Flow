...
# Ensure group and subject are treated as separate variables
pca_data <- pca_data %>%
  mutate(treatment_stage = as.factor(group.1),
...
ggplot(pca_data, aes(x = PC1, y = PC2, color = treatment_stage, shape = subject)) +
  geom_point(size = 3) +
