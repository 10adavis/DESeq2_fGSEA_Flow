...
Rversion<-R.Version()
RNAseq_GSEA_Flow_version<-"v1.0"
RNAseq_GSEA_Flow_URL<-"https://github.com/10adavis/RNAseq_GSEA_Flow/releases/tag/v1.0"
```

RNAseq_GSEA_Flow `r RNAseq_GSEA_Flow_version`

## Introduction

RNAseq_GSEA_Flow has been produced to provide a standardized RNA-seq analysis pipeline.
...
RNAseq_GSEA_Flow was developed to automate these analyses in a logical and fully reproducible manner. 
...
## Template used:
This repository was generated from [10adavis/RNAseq_GSEA_Flow `r RNAseq_GSEA_Flow_version`](`r RNAseq_GSEA_Flow_URL`). 
